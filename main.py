...
def main():
    test = Siege("glaive thrower",200,20,"normal",0,"heavy",1.0,18,None,True,True,True)
    test2 = Warior("Troll Headhunter",150,20,"normal",0,"heavy",0.75,5,None,None,True,True,True)
